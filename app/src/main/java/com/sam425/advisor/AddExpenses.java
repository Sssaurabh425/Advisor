...
public class AddExpenses extends AppCompatActivity implements View.OnClickListener,NavigationView.OnNavigationItemSelectedListener,AdapterView.OnItemSelectedListener {
       ...
       toolbar = (android.support.v7.widget.Toolbar) findViewById(R.id.toolbar);
        ...
        btnFollow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String pname = getIntent().getStringExtra("v1");
                String pprice = getIntent().getStringExtra("v2");
                //UserInformation userInformation = new UserInformation(date, time, amount, merchant, category);
                UserInformation1 userInformation1 = new UserInformation1(date, time, amount, merchant, category,pname,pprice);

                FirebaseUser user = firebaseAuth.getCurrentUser();


                if (TextUtils.isEmpty(amount)) {
                    Toast.makeText(AddExpenses.this, "Enter Amount"
                ...
                if (TextUtils.isEmpty(date)) {
                    Toast.makeText(AddExpenses.this, "Enter Date"
                            , Toast.LENGTH_SHORT).show();
                    return;

                }
                if (TextUtils.isEmpty(time)) {
                    Toast.makeText(AddExpenses.this, "Enter Time"
                            , Toast.LENGTH_SHORT).show();
                    return;
                ...
                if (TextUtils.isEmpty(merchant)) {
                    Toast.makeText(AddExpenses.this, "Enter merchant name"
                            , Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(category)) {
                    Toast.makeText(AddExpenses.this, "Enter category name"
                            , Toast.LENGTH_SHORT).show();
                    return;
                }
                databaseReference.child("user").child(user.getUid()).child("expenses").child(id).setValue(userInformation1);
                Toast.makeText(AddExpenses.this, "Data is Successfully Added"
                        , Toast.LENGTH_SHORT).show();
                ...
                Intent addexpenses=new Intent(AddExpenses.this,ProfileActivity.class);
    ...
    private void showDatePickerDialog()
    {
        ...
        datePickerDialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddExpenses.this, onDateSetListener, year, month, day);
    ...
    private void showTimePickerDialog()
    {
        ...
        timePickerDialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(AddExpenses.this, onTimeSetListener, hour, minute, is24Hour);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem.OnActionExpandListener onActionExpandListener = new MenuItem.OnActionExpandListener() {
            ...
            public boolean onMenuItemActionExpand(MenuItem item) {
                Toast.makeText(AddExpenses.this, "Action View Expanded..", Toast.LENGTH_SHORT).show();
                return true;
            }

            @Override
            public boolean onMenuItemActionCollapse(MenuItem item) {
                Toast.makeText(AddExpenses.this, "Action View Collapsed..", Toast.LENGTH_SHORT).show();
                return true;
            }
        };
         return true;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            case R.id.action_settings:
                ...
                return true;
            case R.id.action_mf:
                Intent i=new Intent(AddExpenses.this,AddMutualFund.class);
                startActivity(i);
                return true;
            case R.id.home:
                Intent j=new Intent(AddExpenses.this,ProfileActivity.class);
                startActivity(j);
                return true;
            default:
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.addexpenses1:
                Intent i=new Intent(AddExpenses.this,AddExpenses.class);
                startActivity(i);
                break;
            case R.id.addsubuser:
                Intent j=new Intent(AddExpenses.this,AddSubUser.class);
                startActivity(j);
                break;
            case R.id.showexpenses:
                /*getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                        new ProfileFragment()).commit();*/
                Intent k=new Intent(AddExpenses.this,ExpensesData.class);
                startActivity(k);
                break;
            case R.id.addearning:
                Intent l=new Intent(AddExpenses.this,earning.class);
                startActivity(l);
                break;
            case R.id.showearning:
                Intent m=new Intent(AddExpenses.this,EarningData.class);
                startActivity(m);
                break;
            case R.id.sipcalculator:
                Intent n=new Intent(AddExpenses.this,sip_calculator.class);
                startActivity(n);
                break;
            case R.id.Savebill:
                Intent p=new Intent(AddExpenses.this,cameraActivity.class);
                startActivity(p);
                break;
            case R.id.Tasktodo:
                Intent q=new Intent(AddExpenses.this,MainTodoActivity.class);
                startActivity(q);
                break;
                case R.id.billpayment:

                    Intent qa=new Intent(AddExpenses.this,billgeneration.class);
                    startActivity(qa);
                break;
            case R.id.saving:
                Intent t=new Intent(AddExpenses.this,ExpensesData.class);
                startActivity(t);
                break;
            case R.id.investment:
                Intent u=new Intent(AddExpenses.this,ExpensesData.class);
                startActivity(u);
                break;
            case R.id.complaint:
                Intent v=new Intent(AddExpenses.this,RegisterComplaint.class);
                startActivity(v);
                break;
            case R.id.budget:
                Intent w=new Intent(AddExpenses.this,AddBudget.class);
                startActivity(w);
                break;
        }
        drawer.closeDrawer(GravityCompat.START);
